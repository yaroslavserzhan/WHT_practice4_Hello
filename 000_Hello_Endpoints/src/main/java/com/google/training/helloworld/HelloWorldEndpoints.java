...
public class HelloWorldEndpoints 
{
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="greetVariant", path = "greetVariant", httpMethod = HttpMethod.GET)
    public HelloClass greetVariant(@Named("name") String name,  @Named("variant") int variant)
    {
    	return new HelloClass(name,variant);
    }
