...
function enableButtons () {
	...
	btn = document.getElementById("input_variant");
	btn.onclick=function(){greetVariant();};
...
function greetVariant()
{
	var name = document.getElementById("name_field3").value;
	var variant = document.getElementById("variant_field").value;
	var request = gapi.client.helloworldendpoints.greetVariant({'name': name, 'variant':variant});
	request.execute(sayHelloCallback);
}
